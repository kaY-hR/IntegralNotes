...
export const DEFAULT_AI_CHAT_SYSTEM_PROMPTS: AiChatSystemPrompts = {
  ...
  inlinePythonBlock: [
    ...
    "Create or revise analysis block scripts only in visible workspace paths. Do not save generated block scripts under hidden/system directories such as .packages, .integral-sdk, .store, .inline-action, .codex, or .claude.",
    "If you use a package-provided script under .packages as a reference, copy or adapt it into a visible workspace path and insert that visible script; do not extend the package subtree.",
  ...
  promptlessContinuation: [
    ...
    "Save Python analysis block scripts in visible workspace paths, normally scripts/ai_blocks/; do not save or insert generated scripts under hidden/system directories such as .packages, .integral-sdk, .store, .inline-action, .codex, or .claude.",
